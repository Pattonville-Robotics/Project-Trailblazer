...
public class GridSquare implements Cloneable, Serializable {
    ...
    public Rectangle getBounds() {
        return new Rectangle(this.x / this.superGrid.getSquareWidth(), this.y / this.superGrid.getSquareHeight(), this.width / this.superGrid.getSquareWidth(), this.height / this.superGrid.getSquareHeight());
    }
