package org.electronauts.mathutil;
...
public class Vector2D {
	 ...
	 *
	 * @param v1 the first {@code Vector2D}
	 * @param v2 the second {@code Vector2D}
	 ...
	 *
	 * @param x the x coordinate of the end point of the vector
	 * @param y the y coordinate of the end point of the vector
	 ...
	 *
	 * @param theta the angle between a line intersecting both the origin and this point and the positive x-axis
	 * @param rho   the distance from the origin to this point
