...
public class HolonomicRobot extends AbstractRobot {
	...
	public void paint(final Graphics2D g2d, final int scale) {
		...
		g2d.drawLine((int) (scale * this.getMotor(MotorData.MOTOR_FRONT_LEFT).getX()), (int) (scale * this.getMotor(MotorData.MOTOR_FRONT_LEFT).getY()), (int) (scale * (this.getMotor(MotorData.MOTOR_FRONT_LEFT).getX() + p1.getX())), (int) (scale * (this.getMotor(MotorData.MOTOR_FRONT_LEFT).getY() + p1.getY())));

		g2d.drawLine((int) (scale * this.getMotor(MotorData.MOTOR_FRONT_RIGHT).getX()), (int) (scale * this.getMotor(MotorData.MOTOR_FRONT_RIGHT).getY()), (int) (scale * (this.getMotor(MotorData.MOTOR_FRONT_RIGHT).getX() + p2.getX())), (int) (scale * (this.getMotor(MotorData.MOTOR_FRONT_RIGHT).getY() + p2.getY())));

		g2d.drawLine((int) (scale * this.getMotor(MotorData.MOTOR_BACK_LEFT).getX()), (int) (scale * this.getMotor(MotorData.MOTOR_BACK_LEFT).getY()), (int) (scale * (this.getMotor(MotorData.MOTOR_BACK_LEFT).getX() + p3.getX())), (int) (scale * (this.getMotor(MotorData.MOTOR_BACK_LEFT).getY() + p3.getY())));

		g2d.drawLine((int) (scale * this.getMotor(MotorData.MOTOR_BACK_RIGHT).getX()), (int) (scale * this.getMotor(MotorData.MOTOR_BACK_RIGHT).getY()), (int) (scale * (this.getMotor(MotorData.MOTOR_BACK_RIGHT).getX() + p4.getX())), (int) (scale * (this.getMotor(MotorData.MOTOR_BACK_RIGHT).getY() + p4.getY())));
	}
